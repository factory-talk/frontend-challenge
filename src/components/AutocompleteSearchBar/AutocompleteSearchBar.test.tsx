...
const mockExtendedLocationData: ExtendedLocationData[] = [
  {
    location: {
      ...
      lat: '40.44674025',
      lon: '-79.9446837',
      boundingbox: ['40.4464078', '40.4470515', '-79.9449946', '-79.944411'],
      class: 'amenity',
      type: 'studio',
      display_name:
        'WQED, 4802, Fifth Avenue, Shadyside, Pittsburgh, Allegheny County, Pennsylvania, 15213, USA',
      display_place: 'WQED',
      display_address:
        '4802, Fifth Avenue, Shadyside, Pittsburgh, Allegheny County, Pennsylvania, 15213, USA',
      address: {
        name: 'WQED',
        city: 'Pittsburgh',
  ...
  },
  {
    location: {
      ...
      lat: '41.0173684',
      lon: '-75.9105845',
      boundingbox: ['41.0173184', '41.0174184', '-75.9106345', '-75.9105345'],
      class: 'man_made',
      type: 'tower',
      display_name:
        'WQEQ-FM (Freeland), Harding Street, Pardeesville, Luzerne County, Pennsylvania, 18224, USA',
      display_place: 'WQEQ-FM (Freeland)',
      display_address:
        'Harding Street, Pardeesville, Luzerne County, Pennsylvania, 18224, USA',
      address: {
...
describe('AutocompleteSearchBar', () => {
  ...
  test('adds location when selected', () => {
    ...
    expect(mockOnSearchClickAdd).toHaveBeenCalledWith(
      mockExtendedLocationData[0],
    );
